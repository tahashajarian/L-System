const init = () => {
    ...
    // const lSystem = new LSystem(['F'], { '+': -90, "-": +90 }, 'F', { 'F': 'F+F-F-F+F' }, 'corner',  10)
    // const lSystem = new LSystem(['F', 'G'], { '+': 120, "-": -120 }, 'F-G-G', { 'F': 'F-G+F+G-F', 'G': 'GG' }, 'corner', 10)
    // const lSystem = new LSystem(['A', 'B'], { '+': 60, "-": -60 }, 'A', { 'A': 'B-A-B', 'B': 'A+B+A' }, 'corner', 10)
    const lSystem = new LSystem(['F', 'G'], { '+': -90, "-": 90 }, 'F', { 'F': 'F+G', 'G': 'F-G' }, 'center', 10)
    // const lSystem = new LSystem(['F', 'G'], { '+': -25, "-": 25 }, 'X', { 'F': 'FF', 'X': 'F+[[X]-X]-F[-FX]+X' }, 'centerBottom', 10)
    // const lSystem = new LSystem(['F', 'G'], { '+': -25, "-": 25 }, 'FX', { 'F': 'FF', 'X': 'F+[-F-XF-X][+FF][--XF[+X]][++F-X]' }, 'centerBottom', 10)
    // const lSystem = new LSystem(['F', 'G'], { '+': -25, "-": 25 }, 'X', { 'F': 'FX[FX[+XF]]', 'X': 'FF[+XZ++X-F[+ZX]][-X++F-X]', 'Z': '[+F-X-F][++ZX]' }, 'centerBottom', 40)
...
class LSystem {
    constructor(variables, constants, start, rules, startPosition, lineSize) {
        ...
        this.generatedTextContainerEl = document.getElementById("generatedTextContainer")
